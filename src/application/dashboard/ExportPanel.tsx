...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/radix/form/select";
import { Label } from "@/radix/common/label";
import { mockSelectCollections } from "@/data/mock/mockdata";
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <Select onValueChange={setSelectedCollection} value={selectedCollection}>
                            ...
                            <SelectContent>
                                {mockSelectCollections.map((collectionName) => (
